 ...
 * Orders Model
 *
 * @property \App\Model\Table\SubaddressTable|\Cake\ORM\Association\BelongsTo $Subaddress
 *
...
class OrdersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Subaddress', [
            'foreignKey' => 'subaddress_id',
            'joinType' => 'INNER'
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn(['subaddress_id'], 'Subaddress'));
