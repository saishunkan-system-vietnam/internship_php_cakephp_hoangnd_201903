 ...
 * Roles Model
 *
 * @property \App\Model\Table\RoleDetailsTable|\Cake\ORM\Association\BelongsTo $RoleDetails
...
class RolesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['role_details_id'], 'RoleDetails'));
