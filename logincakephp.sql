...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2019 at 11:35 AM
...
--
CREATE DATABASE IF NOT EXISTS `logincakephp` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `logincakephp`;
...
CREATE TABLE `chitietloaihang` (
  `id` int(11) NOT NULL,
  `tenchitietloaihang` int(11) NOT NULL,
...
ALTER TABLE `chitietloaihang`
  ADD KEY `fk_loaihang_id` (`loaihang_id`);
...
--
ALTER TABLE `chitietloaihang`
  ADD CONSTRAINT `fk_loaihang_id` FOREIGN KEY (`loaihang_id`) REFERENCES `loaihang` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
('root', '[{\"db\":\"logincakephp\",\"table\":\"chitietloaihang\"},{\"db\":\"logincakephp\",\"table\":\"loaihang\"},{\"db\":\"logincakephp\",\"table\":\"thongso\"},{\"db\":\"logincakephp\",\"table\":\"mathang\"},{\"db\":\"logincakephp\",\"table\":\"nhomhang\"},{\"db\":\"logincakephp\",\"table\":\"roles\"},{\"db\":\"logincakephp\",\"table\":\"role_details\"},{\"db\":\"logincakephp\",\"table\":\"chitietthongso\"},{\"db\":\"logincakephp\",\"table\":\"MatHang\"},{\"db\":\"logincakephp\",\"table\":\"users\"}]');
...
('root', 'logincakephp', 'users', '{\"sorted_col\":\"`users`.`password` ASC\"}', '2019-03-08 06:49:53');
...
('root', '2019-03-12 05:50:53', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
